...
if __name__ == "__main__" :
    ...
    incoming_purge_message_handler = MessageHandler(
        ...
        filters=Filters.command(["purgevideo@LeechToVideoBot"]) & Filters.chat(chats=AUTH_CHANNEL)
    )
    ...
    incoming_g_clear_handler = MessageHandler(
        g_clearme,
        filters=Filters.command(["renewmevideo@LeechToVideoBot"]) & Filters.chat(chats=AUTH_CHANNEL)
    )
    ...
    incoming_youtube_playlist_dl_handler = MessageHandler(
        g_yt_playlist,
        filters=Filters.command(["pytdlvideo@LeechToVideoBot"]) & Filters.chat(chats=AUTH_CHANNEL)
    )
    ...
    exec_message_handler = MessageHandler(
        exec_message_f,
        filters=Filters.command(["execvideo@LeechToVideoBot"]) & Filters.chat(chats=AUTH_CHANNEL)
    )
    ...
    eval_message_handler = MessageHandler(
        eval_message_f,
        filters=Filters.command(["evalvideo@LeechToVideoBot"]) & Filters.chat(chats=AUTH_CHANNEL)
    )
    ...
    rename_message_handler = MessageHandler(
        rename_message_f,
        filters=Filters.command(["renamevideo@LeechToVideoBot"]) & Filters.chat(chats=AUTH_CHANNEL)
    )
    ...
    help_text_handler = MessageHandler(
        help_message_f,
        filters=Filters.command(["helpvideo@LeechToVideoBot"]) & Filters.chat(chats=AUTH_CHANNEL)
    )
